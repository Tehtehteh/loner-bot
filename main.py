...
from bot.handlers.ticket_info_survey import (
    get_arrival_station, get_date, get_departure_station, get_departure_station_input,
...
def main():
    ...
    dispatcher.register_message_handler(start_ticket_info_survey, commands=['start'])
    dispatcher.register_message_handler(cancel_order_handler, commands=['cancel'], state='*')
